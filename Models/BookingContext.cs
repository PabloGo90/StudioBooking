...
public class BookingContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity("TattooStudioBooking.Artista").HasData(new { Id = 4, Instagram = "", IsAdmin = false, Nombre = "nombre", UserName = "Ales", PasswordStored =  security.Encrypt("pwd", "1234") });
        ...
        modelBuilder.Entity("TattooStudioBooking.PuestoTrabajo").HasData(new { Id = 4, Nombre = "Puesto Alex" });
